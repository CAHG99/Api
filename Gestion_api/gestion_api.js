...
function agregarProducto() {
  ...
  fetch(url, {
    ...
    .then(data => {
      ...
      obtenerProductos(); // Recargar la tabla
...
// Ejemplos de uso
// obtenerProductos();     // Muestra todos los usuarios
// // agregarProducto();        // Crea un nuevo usuario
// editarProducto(1);      // Edita el usuario con ID 1
// eliminarProducto(2);    // Edita el usuario con ID 1